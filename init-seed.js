...
const config = {
  ...defaultConfig,
  githubPage: 'lifaon74/common-classes',
  packageName: '@lifaon/common-classes',
  libName: 'common-classes',
...
const tags = Object.entries({
  'lifaon74/common-classes': config.githubPage,
  '@lifaon/common-classes': config.packageName,
  'common-classes': config.libName,
