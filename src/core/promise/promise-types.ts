import type { ILightPromiseLike, TInferLightPromiseLikeType, TInferPromiseLikeOrValue } from './promise-like-types';
import type { IAdvancedAbortSignalLike } from '../abortable/advanced-abort-signal/advanced-abort-signal-types';
...
export type INativeCancellablePromiseTuple<T> = {
  promise: Promise<T>,
  signal: IAdvancedAbortSignalLike,
};
