...
import { IsNotificationsObserverLike } from '../../../../../notifications/core/notifications-observer/notifications-observer-types';
...
export function ConstructObserver<GValue>(
  ...
  if (!DOT_NOT_VERIFY_TYPES && (typeof emit !== 'function')) {
