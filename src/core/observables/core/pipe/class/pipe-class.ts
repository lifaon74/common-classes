...
import { ISimpleObservableLike, IsObservableLike, } from '../../observable/built-in/simple/simple-observable-types';
...
export function ConstructPipe<GObservable extends ISimpleObservableLike<GObserver>, GObserver extends TGenericObserverLike>(
...
export interface IPipeImplementations<GObservable extends ISimpleObservableLike<GObserver>, GObserver extends TGenericObserverLike> extends
...
export interface IPipeImplementationsConstructor {
  new<GObservable extends ISimpleObservableLike<GObserver>, GObserver extends TGenericObserverLike>(): IPipeImplementations<GObservable, GObserver>;
}


export interface IPipe<GObservable extends ISimpleObservableLike<GObserver>, GObserver extends TGenericObserverLike> extends IPipeStruct<GObservable, GObserver>, IPipeImplementations<GObservable, GObserver> {
}

const PipeImplementationsConstructor = AssembleTraitImplementations<IPipeImplementationsConstructor>(PipeImplementations);

export class Pipe<GObservable extends ISimpleObservableLike<GObserver>, GObserver extends TGenericObserverLike> extends PipeImplementationsConstructor<GObservable, GObserver> implements IPipe<GObservable, GObserver> {
