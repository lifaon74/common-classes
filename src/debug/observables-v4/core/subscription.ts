...
export interface ISubscription<GValue> {
  readonly observable: IObservable<GValue>;
  readonly observer: IObserver<GValue>;
...
export class Subscription<GValue> implements ISubscription<GValue> {
  public readonly observable: IObservable<GValue>;
  public readonly observer: IObserver<GValue>;
...
// export class ReadonlyMultiSubscriptions<GValue> {
...
//
//
// export class MultiSubscriptions<GValue> extends ReadonlyMultiSubscriptions<GValue> {
//   constructor(
//     observables: Iterable<IObservable<GValue>> = [],
//     observers: Iterable<IObserver<GValue>> = [],
//   ) {
