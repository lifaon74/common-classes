...
export type PipeFirstArgRaw<GFunctions extends GUnaryFunction[], GUnaryFunction extends GenericUnaryFunction = GenericUnaryFunction> =
...
export type PipeFirstArg<GFunctions extends GUnaryFunction[], GUnaryFunction extends GenericUnaryFunction = GenericUnaryFunction> =
  GFunctions extends []
    ? unknown
    : PipeFirstArgRaw<GFunctions, GUnaryFunction>;


export type PipeLastReturnRaw<GFunctions extends GUnaryFunction[], GUnaryFunction extends GenericUnaryFunction = GenericUnaryFunction> =
...
export type PipeLastReturnOrValue<GFunctions extends GUnaryFunction[], GValue, GUnaryFunction extends GenericUnaryFunction = GenericUnaryFunction> =
  GFunctions extends []
    ? GValue
    : PipeLastReturnRaw<GFunctions, GUnaryFunction>;

export type PipeLastReturn<GFunctions extends GUnaryFunction[], GUnaryFunction extends GenericUnaryFunction = GenericUnaryFunction> =
  PipeLastReturnOrValue<GFunctions, unknown, GUnaryFunction>;

export type PipeNowReturn<GValue, GFunctions extends GUnaryFunction[], GUnaryFunction extends GenericUnaryFunction = GenericUnaryFunction> =
  PipeLastReturnOrValue<GFunctions, GValue, GUnaryFunction>;


export type PipeReturnRaw<GFunctions extends GUnaryFunction[], GUnaryFunction extends GenericUnaryFunction = GenericUnaryFunction> =
  (value: PipeFirstArgRaw<GFunctions, GUnaryFunction>) => PipeLastReturnRaw<GFunctions, GUnaryFunction>;

export type PipeReturn<GFunctions extends GUnaryFunction[], GUnaryFunction extends GenericUnaryFunction = GenericUnaryFunction> =
  GFunctions extends []
    ? <GValue>(value: GValue) => GValue
    : PipeReturnRaw<GFunctions, GUnaryFunction>;


export type PipeConstraint<GFunctions extends GUnaryFunction[], GFirstArg = any, GUnaryFunction extends GenericUnaryFunction = GenericUnaryFunction> =
  [GFunctions] extends [[]]
    ? []
    : (
      [GFunctions] extends [[infer GFirst, ...infer GRest]]
