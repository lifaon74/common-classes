...
export function mergeAllOperator<GValue>(): ISubscribePipeFunction<ISubscribeFunction<GValue>, GValue> {
...
export function mergeAllWithNotificationsOperator<GValue>(): ISubscribePipeFunction<IMergeAllInNotifications<GValue>, IMergeAllOutNotifications<GValue>> {
