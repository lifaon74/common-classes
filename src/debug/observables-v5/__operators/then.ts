import { toPromise } from '../subscribe-function/to/to-promise/to-promise';
import { throwError } from '../subscribe-function/from/others/throw-error';
import { IErrorNotification } from '../../observables-v4/misc/notifications/build-in/error-notification';
import { ISubscribeFunctionOfNotifications, ofWithNotifications } from '../subscribe-function/from/others/of-with-notifications';
...
): ISubscribePipeFunction<IDefaultNotificationsUnion<GInNextValue> | IGenericNotification, GOut> {
...
export function rejectedOperator<GInNextValue, GOut>(
  onRejected: IThenOperatorOnRejected<GOut>,
): ISubscribePipeFunction<IDefaultNotificationsUnion<GInNextValue>, GOut | ISubscribeFunctionOfNotifications<GInNextValue>> {
