...
export function dateTimeShortcutFormatToDateTimeFormatOptionsSubscribePipe(): ISubscribePipeFunction<IDateTimeShortcutFormat, DateTimeFormatOptions> {
  return mapSubscribePipe<IDateTimeShortcutFormat, DateTimeFormatOptions>(dateTimeShortcutFormatToDateTimeFormatOptions);
}
